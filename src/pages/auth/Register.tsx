...
const Register = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Flexible Email Validation for KLE Tech USN
        const emailRegex = /^[0-9]{2}[a-z]{2}[0-9]{2}[a-z]{3}[0-9]{3}@kletech\.ac\.in$/i;
        if (!emailRegex.test(email.trim())) {
            toast.error("Invalid email. Must be a valid KLE Tech USN email (e.g., 01fe23bcs157@kletech.ac.in)");
            return;
        }
    ...
    return (
        <div className="min-h-screen font-sans selection:bg-primary/20 overflow-hidden relative flex items-center justify-center">
            ...
            <Card className="w-full max-w-[450px] mx-4 shadow-2xl border border-white/50 bg-white/60 backdrop-blur-xl rounded-[2rem] overflow-hidden relative animate-fade-in-up">
                ...
                <CardHeader className="space-y-4 text-center pt-10 pb-2 relative z-10">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-gray-600 font-medium">Join the campus food revolution</p>
                    </div>
                </CardHeader>
                ...
                <CardContent className="p-8 pt-4 relative z-10">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-600 font-medium">
                            ...
                            <Link to="/auth/login" className="text-primary hover:text-orange-600 font-bold hover:underline transition-all">
                                Login
                            </Link>
                        </p>
                    </div>
